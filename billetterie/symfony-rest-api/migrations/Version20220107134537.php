 ...
 */
final class Version20220107134537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE matchs (id INT AUTO_INCREMENT NOT NULL, id_planning_id INT NOT NULL, id_vainqueur_id INT DEFAULT NULL, id_perdant_id INT NOT NULL, etape VARCHAR(255) NOT NULL, score VARCHAR(255) NOT NULL, est_double TINYINT(1) NOT NULL, id_joueur1 INT NOT NULL, id_joueur2 INT NOT NULL, id_equipe1 INT NOT NULL, id_equipe2 INT NOT NULL, INDEX IDX_6B1E604125949EE6 (id_planning_id), INDEX IDX_6B1E604154FD409C (id_vainqueur_id), INDEX IDX_6B1E6041AFC669F3 (id_perdant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
