 ...
 */
final class Version20220113080718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP INDEX IDX_42C8495529D76B4B, ADD UNIQUE INDEX UNIQ_42C8495529D76B4B (id_joueur_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP INDEX UNIQ_42C8495529D76B4B, ADD INDEX IDX_42C8495529D76B4B (id_joueur_id)');
    }
}
