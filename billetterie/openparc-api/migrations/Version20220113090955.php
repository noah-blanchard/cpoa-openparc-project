 ...
 */
final class Version20220113090955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rencontre CHANGE reservations_id reservations INT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE rencontre CHANGE reservations reservations_id INT DEFAULT NULL');
